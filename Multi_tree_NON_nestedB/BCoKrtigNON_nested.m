function [Zt_real,site_real,prCurr,AA,tau2, a_new,lim_all, KrigS,Var_krigS,Krig_site, Krig_W_etaMAT, Krig_site_eta]=...
    BCoKrtigNON_nested(PR_CURR,SITE_real,ZT_real,n,AA_E,LIM_ALL,a_new,a_NODES,NODES,pprop, aalpha, bbeta,S,low_l,site_e,n_e,BB,Delta,tau1,TAU2,bound,funname)
    ...
    for ii=1:a_NODES
        if (NODES{ii}.inter==0)
           ...
           for jj=1:1 % to inprouve convergency we may use 3 or 4;     
            ...
            if (i<10)
                [New_Z{hh2}, Var_Z{hh2}]=Krig_Multi(Zt_real{hh2},beta{hh2},rho{hh2},sigma2{hh2},AA{hh2},site_real{hh2},site_add{hh2},tt,tau2{hh2},funname2);
            else
                [New_Z{hh2}, Var_Z{hh2}]=Imputation_MultiB(Zt_real{hh2},beta{hh2},rho{hh2},sigma2{hh2},AA{hh2},site_real{hh2},site_add{hh2},tt,tau2{hh2},funname2);
            end 
