function [Zt,site,prCurr,AA,a_new,lim_all, KrigS,Var_krigS,Krig_rho, Krig_W_etaMAT, Krig_site_eta]=...
    BTMulti(PR_CURR,SITE,ZT,n,AA_E,LIM_ALL,a_new,a_NODES,NODES,pprop, aalpha, bbeta,S,low_l,site_e,n_e,BB,tau1,tau2,Delta,bound,funname)
   ...
   clear Zt; clear AA; clear beta_X; clear site; clear lim_all;
    ...
    for ii=1:a_NODES
        if (NODES{ii}.inter==0)
            ...
            Zt{hh2}= ZT{ii};           
            site{hh2}=SITE{ii}; 
            AA{hh2}= AA_E{ii}; tau2A{hh2}{1}=tau2;  tau2A{hh2}{2}=tau2; % tau2A{hh2}{3}=tau2; 
